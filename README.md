...
Nothing about players, worlds, IPs, the server, or anything typed after a command is sent. The plugin
says on every startup whether reporting is on. To turn it off:
